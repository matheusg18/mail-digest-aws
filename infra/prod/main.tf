# ==============================================================================
# TERRAFORM AND GCP PROVIDER CONFIGURATION
#
# Sets up the Terraform backend for secure state management and configures the
# Google Cloud provider with the project and region.
# ==============================================================================
terraform {
  required_providers {
    google = {
...
# Make the webhook function publicly accessible
